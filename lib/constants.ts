...
export const PRICE_LIST = [
  {
    ...
    items: [
      ...
      { name: 'Solar Nails Fill White Tip', price: '$55' },
      { name: 'Ombre Nails New Set', price: '$75' },
      { name: 'Ombre Nails Fill', price: '$55' },
      { name: 'Clear Acrylic Nails New Set', price: '$53' },
      { name: 'Acrylic Fill White Tip', price: '$53' },
      { name: 'Clear Acrylic Nails Fill', price: '$33' },
      { name: 'Dipping Powder', price: '$55' },
      { name: 'Nails Repair', price: '$10 & up' },
      { name: 'Manicure Shellac Ombre', price: '$50' },
      { name: 'Artificial Nails Take Off', price: '$20 & up' },
  ...
  },
  {
    ...
    items: [
      { name: 'Shellac Color Only', price: '$30' },
      { name: 'Shellac French / Color Only', price: '$35' },
      { name: 'Shellac Color Change / French', price: '$40' },
      { name: 'Shellac Color Change', price: '$35' },
      { name: 'Regular Color Change', price: '$20' },
      { name: 'Chrome', price: '$10 & up' },
      { name: 'Nails Cut & Shape', price: '$15 & up' },
      { name: 'Nails Art Design', price: '$8' },
      { name: 'Eyelash New Set', price: '$95' },
      { name: 'Eyelash Fill', price: '$75' },
      { name: 'Eyelash Take Off', price: '$30' },
    ],
  },
  {
    category: 'Waxing',
