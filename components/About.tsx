        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col gap-0">
              <div className="bg-surface rounded-t-2xl px-8 pt-8 pb-6 flex flex-col gap-6">
                <div>
                  ...
                  <a
                    ...
                    className="text-[#6B6B6B] hover:text-primary transition-colors text-sm"
                  >
                    {BUSINESS.address}
                  </a>
                </div>
                <div>
                  ...
                  <a href={BUSINESS.phoneHref} className="text-[#6B6B6B] hover:text-primary transition-colors text-sm">
                    {BUSINESS.phone}
                  </a>
                </div>
                <div>
                  <h3 className="font-serif text-lg font-bold text-[#1A1A1A] mb-3">Follow Us</h3>
              ...
              {/* Map directly below the info panel */}
              <div className="rounded-b-2xl overflow-hidden h-56">
                <iframe
