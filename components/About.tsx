      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">About Pearl Nails &amp; Spa</h2>
            ...
            <div className="inline-flex items-center gap-3 bg-primary/10 text-primary font-semibold px-6 py-3 rounded-full">
              <span className="text-xl">🚶</span>Walk-ins Welcome
            </div>
          </div>
          <div className="bg-surface rounded-2xl p-8 flex flex-col gap-6">
            <div>
              ...
              <a href={`https://maps.google.com/?q=${encodeURIComponent(BUSINESS.address)}`} target="_blank" rel="noopener noreferrer" className="text-[#6B6B6B] hover:text-primary transition-colors">{BUSINESS.address}</a>
            </div>
            <div>
              <h3 className="font-serif text-lg font-bold text-[#1A1A1A] mb-2">Phone</h3>
              <a href={BUSINESS.phoneHref} className="text-[#6B6B6B] hover:text-primary transition-colors">{BUSINESS.phone}</a>
            </div>
            <div>
              <h3 className="font-serif text-lg font-bold text-[#1A1A1A] mb-2">Follow Us</h3>
              <div className="flex gap-4">
                <a href={BUSINESS.instagram} target="_blank" rel="noopener noreferrer" className="text-[#6B6B6B] hover:text-primary transition-colors font-medium">Instagram</a>
                <a href={BUSINESS.facebook} target="_blank" rel="noopener noreferrer" className="text-[#6B6B6B] hover:text-primary transition-colors font-medium">Facebook</a>
              </div>
            </div>
          </div>
        </div>
